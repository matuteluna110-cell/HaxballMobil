...
document.querySelector('.gameframe').contentWindow.document.head.appendChild(Object.assign(document.createElement("style"), { innerHTML: ".room-view,.roomlist-view{height:100%;margin-top:0}.game-view>.top-section,.room-view{margin-top:0}.settings-view{width:100%;max-height:none}.game-view>[data-hook=popups]{background-color:#1b0b12cc}.disconnected-view .dialog,.disconnected-view .room-view>.container{width:450px}.create-room-view>.dialog,.room-view.create-room-view>.container{max-width:450px;width:100%}body{background:#1b0b12;box-shadow:inset 0 0 30px #800020} [data-hook=leave-btn]{background:#800020!important;box-shadow:0 0 10px #800020;border-radius:8px}.file-btn,[data-hook=rec-btn]{display:none!important}h1{text-align:center;color:#b03060;text-shadow:0 0 8px #800020}.room-view>.container>.header-btns{bottom:0;right:10px;top:auto}.room-view>.container{max-width:none;max-height:max-content}.room-view{position:absolute;width:100%}.roomlist-view>.dialog{max-width:max-content;max-height:max-content}.game-state-view .bar>.scoreboard{display:flex;align-items:center;margin-right:50px}.chatbox-view{position:absolute;left:15px;margin:0;top:10px;width:30%;pointer-events:none;font-size:1rem;display:contents}.chatbox-view-contents{flex-direction:column-reverse;background:0 0;pointer-events:none}.chatbox-view-contents>.input{margin-bottom:10px;pointer-events:auto}.chatbox-view-contents>.log{flex-direction:column;pointer-events:none;overflow-y:scroll;scrollbar-width:none}.settings-view .section.selected{display:flex;align-items:center}.log-contents{display:flex;flex-direction:column-reverse;text-shadow:1px 1px 5px #000000cc}.fade-out{opacity:0;transition:opacity 10s ease-out}thead tr{display:table-row!important}svg{width:1em}.input-options{position:absolute;width:100%;height:100%;z-index:20;background-color:#1b0b12;box-shadow:inset 0 0 20px #800020}" }));
...
const tips = [
"Tip: mantén una buena posición defensiva.",
"Tip: comunícate y coordínate con tus compañeros de equipo.",
"Tip: practica tus habilidades de regate para superar a los rivales.",
"Tip: aprende a anticipar los movimientos del balón y de los jugadores.",
"Tip: no te apresures al disparar; espera el momento adecuado.",
"Tip: controla la velocidad para mantener el dominio del balón.",
"Tip: usa los rebotes de las paredes para sorprender a tus oponentes.",
"Tip: adapta tu estrategia según el tamaño de la cancha y el modo de juego.",
"Tip: ten paciencia en defensa y espera el momento indicado para atacar.",
"Tip: practica la sincronización de pases y disparos con tu equipo.",
"Tip: mantén el equilibrio entre ataque y defensa.",
"Tip: estudia el estilo de juego de tus rivales para anticipar sus movimientos.",
"Tip: evita quedarte quieto; muévete constantemente para ser impredecible.",
"Tip: mantente cerca de tus compañeros para facilitar los pases.",
"Tip: controla el tiempo restante y ajusta tu estrategia en consecuencia.",
"Tip: aprende a usar los rebotes para crear oportunidades de gol.",
"Tip: sé un jugador versátil y desempeña distintos roles en el equipo.",
"Tip: evita chocar constantemente con tus compañeros; mantén tu espacio.",
"Tip: usa el chat para coordinar rápidamente las tácticas con tu equipo.",
"Tip: analiza tus errores y aprende de ellos para mejorar.",
"Tip: observa a jugadores con experiencia para aprender nuevas estrategias.",
"Tip: no subestimes el impacto de un buen pase; puede cambiar el partido.",
"Tip: mantén la calma bajo presión; la concentración es clave.",
"Tip: juega con regularidad para mejorar tu constancia y habilidad.",
"Tip: coordina la presión con tu equipo para forzar errores del rival.",
"Tip: sé un jugador justo; respeta las reglas.",
"Tip: adapta tu estilo de juego según el número de jugadores en la cancha.",
"Tip: no tengas miedo de probar nuevas tácticas y ajustar tu estrategia.",
"Tip: presta atención a la posición del arquero para evitar goles en contra.",
"Tip: usa los rebotes para realizar disparos inesperados.",
"Tip: aprende a leer el juego del equipo rival para anticipar sus movimientos.",
"Tip: diviértete y disfruta del juego; una actitud positiva mejora tu rendimiento."
];
...
avatarButton.setAttribute("class","neo rounded");
avatarButton.id = "avatarButton";
avatarButton.innerHTML = "✨";

avatarButton.addEventListener("click", function(){

    if(typeof iniciarAvatarAnimado === "function"){
        iniciarAvatarAnimado();
    }

});

body.querySelector('.sound-button-container').parentNode.prepend(avatarButton);
...
for(let nombre in opcionesAvatar){
    ...
    boton.onclick = ()=>{
        ...
        avatares = opcionesAvatar[nombre];
...
// Botón avatar animado
avatarButton = document.createElement("button");
avatarButton.setAttribute("class", "neo rounded sizer");
avatarButton.setAttribute("view", "hidden");
avatarButton.setAttribute("float", "");
avatarButton.setAttribute("id", "avatarButton");
avatarButton.innerHTML = "✨";

avatarButton.addEventListener("touchstart", function(){
    if(avatarAnimando){
        detenerAvatarAnimado();
        avatarButton.innerHTML="✨";
    }else{
        iniciarAvatarAnimado();
        avatarButton.innerHTML="🛑";
...
avatares = tiposAvatar[nombre];
iniciarAvatarAnimado();

};

avatarMenu.appendChild(b);

}


body.appendChild(avatarMenu);
